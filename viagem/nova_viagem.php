...
<body>
                ...
                <div class="col-12 col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formNovaViagem" novalidate>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('process_viagem.php', {
                    method: 'POST',
                ...
                if (data.success) {
                    ...
                    window.location.href = 'dashboard.php?success=1&message=' + encodeURIComponent(data.message);
                } else {
                    alert(data.message || 'Erro ao criar viagem. Tente novamente.');
                }
            } catch (error) {
